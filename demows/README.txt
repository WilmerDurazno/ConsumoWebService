...
a persistence unit "demowsPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "demows\pom.xml":
...
artifact ("demows.war") is already built. You can build
